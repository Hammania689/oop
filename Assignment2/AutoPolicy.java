...
public class AutoPolicy {
   ...
   public boolean checkIfNorthEastState(String state) {
      boolean isNorthEast = false;

      if ((state == "CT") || (state == "MA") || (state == "ME") || (state == "NJ") || (state == "NY") || (state == "PA")
            || (state == "VT")) {
         isNorthEast = true;
         System.out.println(this.getState() + " is one of the North Eastern States!");
      } else {
         System.out.println("ERROR: " + this.getState() + " is not a North Eastern State(CT, MA, ME, NJ, NY, PA, VT)");
      }
   ...
   public void setState(String state) {
      ...
      if (checkIfNorthEastState(state)) {
         this.state = state;
      }
