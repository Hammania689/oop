...
public class AutoPolicyTest {
   public static void main(String[] args) {
      ...
      AutoPolicy policy2 = new AutoPolicy(22222222, "Ford Fusion", "MS");
      AutoPolicy policy3 = new AutoPolicy(22222222, "Ford Fusion", "VA");
      ...
      policy1.checkIfNorthEastState(policy1.getState());
      policy2.checkIfNorthEastState(policy2.getState());
      policy3.checkIfNorthEastState(policy3.getState());
   }
